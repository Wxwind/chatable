...
const InternalTextArea = forwardRef<TextInput, TextAreaProps>((props, ref) => {
  const { autoSize, rows, numberOfLines, onLayout, onContentSizeChange, ...restProps } = props;
  ...
  }, [autoSize, firstLayoutHeight, lineHeight, maxRows, minRows, numberOfLines, onContentSizeChange, onLayout, rows]);
