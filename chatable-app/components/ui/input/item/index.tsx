 ...
 */
export type TextInputProps = Omit<RNTextInputProps, 'onChange' | 'onFocus' | 'onBlur'>;
...
export class InputItem extends React.Component<InputItemProps, InputItemState> {
  static defaultProps = {
    type: 'text',
    editable: true,
    clear: false,
            ...
            <View style={[s.container, containerStyle]}>
              ...
              {extra ? (
                <TouchableWithoutFeedback onPress={onExtraClick}>
                  <View>{typeof extra === 'string' ? <Text style={[s.extra, extraStyle]}>{extra}</Text> : extra}</View>
                </TouchableWithoutFeedback>
              ) : null}
              {error && (
